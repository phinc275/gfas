...
type AggregateStore interface {
	...
	// PessimisticSave saves the uncommitted events for an aggregate pessimistically.
	// returns an error if version of the aggregate has been changed since its read.
	PessimisticSave(ctx context.Context, aggregate Aggregate) error
