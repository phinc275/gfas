...
// GetAppliedVersion returns AggregateBase version without uncommitted events
func (a *AggregateBase) GetAppliedVersion() int64 {
	return a.Version - int64(len(a.UncommittedEvents))
}
