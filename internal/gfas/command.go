...
func (a *UserAchievementsAggregate) ApplyExternalEvent(ctx context.Context, extEvent ExternalEvent) error {
	...
	case *ExternalEventJobCompleted:
		return a.applyExternalEvent(ctx, e)
...
func (a *UserAchievementsAggregate) applyExternalEvent(_ context.Context, e *ExternalEventJobCompleted) error {
...
func (a *UserAchievementsAggregate) applyExternalEventLoyaltyPointsEarned(ctx context.Context, e *ExternalEventLoyaltyPointsEarned) error {
